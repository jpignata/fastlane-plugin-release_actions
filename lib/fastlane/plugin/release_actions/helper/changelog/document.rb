module Changelog
  ...
  # Document provides a simple Domain Specific Language (DSL) for creating Markdown
  # documents. It's fairly limited and meant to just support the subset required to
  # maintain CHANGELOG.md files. Each element takes a block which holds some content
  # to render as that element. Blocks passed to each method is evaluated in the
  # context of a Changelog::Helper instance allowng the use of #link, #bold, #em.
  #
  # ==== Examples
  #
